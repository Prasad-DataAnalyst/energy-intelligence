...
BUCKETS = [
    ("compatibility", 42, "Sign-pair compatibility and matches: 'Are Aries and Leo compatible?', best/worst matches for each sign, soulmate pairs, twin flames, karmic matches, element compatibility. Vary the pairs widely."),
    ("signs",         38, "Single-sign deep dives — personality, hidden traits, dark side, strengths, 'the truth about X', 'X in love', secrets of each sign. Cover all 12 signs across multiple angles."),
    ("love",          33, "Love & relationships by sign: how each sign loves, texts, breaks up, handles jealousy, exes, ghosting, commitment, red flags, ideal date. Emotional and relatable."),
    ("engagement",    28, "Fun, shareable RANKINGS and lists: most powerful, most attractive, most loyal, most dangerous, smartest, most creative, hardest to read, best leaders, luckiest, most misunderstood signs — each with astrological reasoning."),
    ("lunar",         28, "Lunar and timely events: full moon and new moon meaning & rituals, lunar/solar eclipses, blood/blue/super moons, moon in each sign, void-of-course, and how to work with each."),
    ("planets",       32, "The planets: meaning of Venus, Mars, Mercury, Jupiter, Saturn, Uranus, Neptune, Pluto; retrogrades (esp. Mercury); your Venus/Mars/moon sign; planet-in-sign highlights."),
    ("money",         23, "Money, wealth and career by sign: richest signs, best careers/jobs, money luck, side hustles, spending styles, 2nd/8th house wealth, business strengths."),
    ("stockmarket",   20, "Astrology applied to stock markets and trading, as an EDUCATIONAL/HISTORICAL lens: Mercury retrograde and market volatility, Jupiter transits and expansion cycles, Saturn transits and corrections, moon phases and trader psychology, the astrology behind famous historical crashes and rallies (1929, dot-com, 2008), eclipse-season market patterns. Frame every topic around GENERAL astrological patterns and historical case studies. NEVER a specific real-time stock pick, ticker, or piece of financial advice — every angle must read as entertainment/education, not guidance to trade on."),
    ("crypto",        16, "Astrology applied to cryptocurrency, as an EDUCATIONAL/HISTORICAL lens: Uranus (disruption/innovation) and crypto's rise, Bitcoin's January 2009 'genesis' chart, Rahu/Ketu and speculative-asset mania, Mercury retrograde and crypto volatility, Neptune and bubble/hype cycles, the astrology behind historical crypto booms and crashes. Frame every topic as general astrological patterns and historical analysis. NEVER a specific real-time coin pick or financial advice — entertainment/education only."),
    ("political",     18, "Mundane (world-events) astrology applied to POLITICAL HISTORY, U.S.-focused: Saturn returns of a nation, Pluto transits and historical power shifts, the astrology of the USA's founding chart (July 4, 1776), eclipse seasons around historical upheaval, past presidencies/inaugurations as historical case studies. Keep every topic EVERGREEN, HISTORICAL, and NON-PARTISAN: NEVER predict outcomes for a current or upcoming election, and NEVER make claims about specific living politicians — frame everything as historical mundane-astrology analysis and general cyclical patterns, entertainment/education only."),
    ("celebrity",     25, "Celebrity astrology using ONLY PUBLICLY KNOWN birth dates: which sign famous actors/musicians/athletes share, zodiac patterns among award winners or chart-topping artists, celebrity couple sun-sign compatibility (public birth dates only), 'which sign is the most [trait]' celebrity-list content. NEVER speculate about a real person's private life, relationships, health, death, or future — light entertainment sign-personality commentary only, never real news or predictions about a specific living individual."),
    ("concepts",      23, "Foundational concepts: rising/ascendant, sun-moon-rising 'big three', the four elements, the three modalities, the 12 houses, aspects (trine/square/opposition), synastry basics."),
    ("deep",          18, "Advanced/mystical: lunar nodes & destiny, Chiron the wounded healer, Black Moon Lilith, Saturn return, the 12th house, retrograde planets in birth chart, part of fortune, asteroids."),
    ("wellness",      21, "Wellness, self-care and misc: each sign's health & stress style, self-care rituals, spirituality, crystals by sign, tarot-meets-astrology, zodiac myths & history."),
]
